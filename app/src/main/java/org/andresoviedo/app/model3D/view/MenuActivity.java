...
public class MenuActivity extends ListActivity {
    ...
    private enum Action {
        LOAD_MODEL, GITHUB, SETTINGS, HELP, ABOUT, UNKNOWN, DEMO
    }
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        try {
            switch (action) {
                case DEMO:
//                    getView3dOption.setView3D(false);
                    ...
                    break;
                case GITHUB:
                    AndroidUtils.openUrl(this, "https://github.com/johnzhaoy/android-3D-model-viewer");
                    break;
                case LOAD_MODEL:
                    loadModel();
                    break;
