 ...
 *
 */
public class PorcoRosso extends SceneLoader {

	public PorcoRosso(ModelActivity modelActivity) {
		super(modelActivity);
	}
...
//                    addObject(obj12);
                    ...
                    try {
                        ...
                        Object3DData android = Object3DBuilder.loadV5(parent, Uri.parse("assets://assets/models/porco_rosso.obj"));
